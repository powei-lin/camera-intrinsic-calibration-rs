use camera_intrinsic_calibration::optimization::{factors::ReprojectionFactor, homography::homography_to_focal};
...
fn bench_homography_solve(c: &mut Criterion) {
    ...
    c.bench_function("homography_to_focal", |b| b.iter(|| homography_to_focal(black_box(&h))));
}
